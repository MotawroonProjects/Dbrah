package com.app.dbrah.uis.activity_payment;
...
import com.app.dbrah.databinding.ActivityPaypalBinding;
    ...
    private void setUpWebView() {
        ...
        binding.webView.setWebViewClient(new WebViewClient() {
                                             ...
                                             public void onPageFinished(WebView view, String url) {
                                                 ...
                                                 if (url.contains("success")||url.contains("status=1") || url.contains("checkout/done")) {
                                                     setResult(RESULT_OK);
                                                     finish();
                                                     Toast.makeText(PaypalwebviewActivity.this, getString(R.string.payment_suc), Toast.LENGTH_SHORT).show();

                                                 }
                                                 else if(url.contains("error")||url.contains("status=0")){
