package com.app.dbrah.uis.activity_map;
...
import com.app.dbrah.databinding.ActivityMapBinding;
    ...
    private void initView() {
        ...
        binding.btnSelect.setOnClickListener(view -> {
            ...
            if (!address.isEmpty()) {
                ...
                Toast.makeText(MapActivity.this, getResources().getString(R.string.ch_address), Toast.LENGTH_SHORT).show();
            }
